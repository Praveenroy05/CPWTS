...
// create an object for page(Login page) - const loginPage  = new LoginPage() and for dadhboardpage as well
// Inside the test cases - call the methods - loginPage.loginIntoApplication(), dashboarPage.addTheProductToCart()
